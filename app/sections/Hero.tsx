        ...
        <div className='w-full lg:w-1/2'>
          <div className='flex flex-col items-center lg:items-start text-justify'>
            ...
            <span className='my-2 max-w-xl py-6 text-lg lg:text-xl md:mx-0 font-light tracking-tighter mx-4'>
              ...
              Tecnológico y de Estudios Superiores de Monterrey , I&apos;m
              always trying to find new technologies and tools to help me
              develop new experiences for users, and expand my knowledge in the
              area.
              <br />
              I<Heart />
              web design & development, especially React.
            </span>
          </div>
        </div>
        <div className='w-full h-full lg:w-1/2 lg:p-8 '>
          <div className='flex justify-center md:justify-center lg:justify-end content-center'>
            <div
              className='bg-black font-mono text-[6px] md:text-[8px] md:leading-[0.7rem] xl:text-[11px] xl:leading-[0.9rem] leading-[0.5rem]'
              dangerouslySetInnerHTML={{ __html: MarcoPhoto }}
            ></div>
          </div>
        </div>
      </div>
